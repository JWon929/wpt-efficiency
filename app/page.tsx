    ...
    <main>
      <section className="hero" id="overview">
        <nav className="nav container" aria-label="Primary navigation">
          ...
          <div className="nav-links"><a href="#research">Research</a><a href="#methods">Methods</a><a href="#results">Results</a><a href="#progress">Progress</a><a href="#contact">Contact</a></div>
        </nav>
